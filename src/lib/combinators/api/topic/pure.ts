...
export const mapTopicAPITopicInfoToTopicStatisticFeature = (topicInfo:TopicAPIResponse):TopicStatisticFeature => {
    ...
    return {
        ...
        topic_create_time: new Date(create_time),
        last_reply_time: new Date(update_time),
        last_edit_time: edit_time ? new Date(edit_time) : new Date(create_time),
...
export const mapTopicAPITopicInfoToTopicContentFeature = (topicInfo:TopicAPIResponse):TopicContentFeature => {
    const { id,content,title,author,create_time,edit_time,group} = topicInfo
    return {
        topic_id: id,
        content: content,
        title: title,
        ...
        topic_updated_at: new Date(create_time),
        group_id: group.id,
        last_edit_time: edit_time ? new Date(edit_time) : new Date(create_time),
        metadata: topicInfo,
    }
